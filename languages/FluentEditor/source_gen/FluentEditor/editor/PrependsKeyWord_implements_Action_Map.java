...
public class PrependsKeyWord_implements_Action_Map {
  private static final Logger LOG = LogManager.getLogger(PrependsKeyWord_implements_Action_Map.class);
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        LoggingRuntime.logMsgView(Level.DEBUG, "Delete action called for : " + editorContext.getSelectedNode().getConcept(), PrependsKeyWord_implements_Action_Map.class, null, null);
        if (DeletionApproverUtil.approve(editorContext, node)) {
          return;
        }
        editorContext.getSelectedNode().delete();
      }
