...
public class PrependKeyWord_Final_Action {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "final")) {
          return;
        }
        SPropertyOperations.set(node, MetaAdapterFactory.getProperty(0x2d38ea1d8ed2480eL, 0xa77f95b0aabfe4dfL, 0x1571a790125ba484L, 0x1571a790125ba487L, "final"), false);
